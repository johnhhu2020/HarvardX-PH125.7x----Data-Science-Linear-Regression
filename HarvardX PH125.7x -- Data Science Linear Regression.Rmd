...
This video corresponds to the textbook section on confounders.
https://rafalab.github.io/dsbook/association-is-not-causation.html#confounders
...
# dig in untill fully understand the knowledge used here
```{r}
...
![so whats is the major selectivity](C:/Users/qp/Pictures/but is major selectivity, which we call Z, associated with gender.png)

![I don't understand here, why we are doing it this way.  The total percent admitted to each major and percent of women make up the applicants???  And the equation used to calculate major_selectivity](C:/Users/qp/Pictures/one way to check the major selectivity association with gender is to plot the XXXX.png)

![](C:/Users/qp/Pictures/the plot shows the percentage of applicants that were accepted by gender and use color to represents the major.png)

![](C:/Users/qp/Pictures/the colore here are used to represent the major.png)

![](C:/Users/qp/Pictures/this plot can be used to represent the percent admitted by major.png)

![](C:/Users/qp/Pictures/here we stratify the confounder major.png)

![](C:/Users/qp/Pictures/atratify by major and compute the difference then average.png)

![](C:/Users/qp/Pictures/this is something called simpson's paradox.png)
...
This video corresponds to the textbook section on Simpson's paradox.
...
![](C:/Users/qp/Pictures/here is a scatter plot of y versus x.png)

![So it's really z that is negatively correlated with x.](C:/Users/qp/Pictures/now what if take the another variable z into consideration.png)
...
Answer
Incorrect:
Correct, this is one of the three examples of multiple testing included in the video.
Correct, this is one of the three examples of multiple testing included in the video.
You have used 1 of 2 attempts Some
...
correct
Answer
Correct: Correct. Although you can sometimes use linear models, you can't always and exploratory data analysis (stratifying and plotting data) will help determine if there is a confounder.
You have used 1 of 2 attempts Some
...
correct
Answer
Correct: Correct. In all data science projects, it is important to understand the data that you are working with.
...
incorrect
Answer
Incorrect: Incorrect. This is true, but, Simpson’s Paradox refers specifically to cases where the sign of the correlation flips when comparing the entire dataset vs. specific strata.
...
## Questions About Correlation is Not Causation?
...
Topic: Section 3: Confounding / 3.1: Correlation is Not Causation
...
## Course  /  Section 3: Confounding  /  Assessment: Confounding (Verified Learners only)
...
## Questions About Confounding Assessment?
