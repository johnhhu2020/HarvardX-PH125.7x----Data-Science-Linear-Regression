...
![](C:/Users/JJ/Pictures/here the data is approximately normal and conditional distribution is also normal.png)

![](C:/Users/JJ/Pictures/if bivariate normal condition is met we are justified to pose a linear model like this.png)

![](C:/Users/JJ/Pictures/When we fit the model with only one variable without the adjustment, the estimated bb and hr slope.png)

![](C:/Users/JJ/Pictures/when we fit the multivariate model, both slopes go down.png)
...
![](C:/Users/JJ/Pictures/plot of lm predicted r_hat comparing with r in 2002.png)

![](C:/Users/JJ/Pictures/the formula would look like this.png)

![so you need to make the per game team rate comparable to the per plat appearance player rate](C:/Users/JJ/Pictures/for players, a rate that takes into account opportunities is per plat appearance.png)

![why you are picking 2002?  in this model, we dont have information of 2002](C:/Users/JJ/Pictures/make the per game team rate comparable to the per plat appearance player rate.png)
...
![](C:/Users/JJ/Pictures/Here is the calculation of what we want to do in one long line of code.png)
...
![](C:/Users/JJ/Pictures/The player-specific predicted runs computer here can be interpreted as the number of runs we would predict team.png)

![](C:/Users/JJ/Pictures/2002 salaries for each player.png)

![](C:/Users/JJ/Pictures/data wrangling acoss table add information we needed, this is salary.png)
...
![](C:/Users/JJ/Pictures/next well add defence position.png)

![](C:/Users/JJ/Pictures/top_n function.png)

![](C:/Users/JJ/Pictures/need to remove OF position, check baseball knowledge with google.png)

![OF positions are outer fields players, they must runs a lot](C:/Users/JJ/Pictures/baseball LF, CF, RF position.png)

![](C:/Users/JJ/Pictures/also remove pitchers.png)

![](C:/Users/JJ/Pictures/and here is the code doing all above data wrangling.png)

![](C:/Users/JJ/Pictures/finally we add they names of these players.png)
...
![](C:/Users/JJ/Pictures/and here is the outcome, now we have a table with our predicted run statistic.png)

![](C:/Users/JJ/Pictures/plot our outcome, and think about it.png)
...
![](C:/Users/JJ/Pictures/and here is the plot with players that debuted before 1997, remore young players.png)
...
![](C:/Users/JJ/Pictures/people realize bb were important, and other runs shoule be weighted more that singles.png)

![](C:/Users/JJ/Pictures/this is the plot comparing our R_hat with they simple On Base Plus Slugging, there are very correlated.png)
...
![](C:/Users/JJ/Pictures/sophomore slump.png)

![](C:/Users/JJ/Pictures/rookie of the year is the award given to the first year player that judged to have performed the best.png)

![+++ be curiosity +++, does the data confirm the existance of a sophomore slump ???](C:/Users/JJ/Pictures/fox new articles.png)

![](C:/Users/JJ/Pictures/create a table with such statistics of all the rookies of the year players.png)

![since batting average is what people talked about when discussing sophomore slump](C:/Users/JJ/Pictures/specifically we will focus on batting averages.png)

![](C:/Users/JJ/Pictures/rookies of the year experienced sophomore slump is 68%, now how can we calculate that value.png)

![](C:/Users/JJ/Pictures/now lets check rockie of the year and sophomore slump again with this code.png)

![we see same patterns here batting averages slump in these players, but ther are not reworded as rookies of the year.png](C:/Users/JJ/Pictures/we see same patterns here batting averages slump in these players, but ther are not reworded as rookies of the year.png)

![](C:/Users/JJ/Pictures/and now checking the worse performers, they batting averages goes up in sophomore, so its really just regression I assume.png)

![correlation for performance in 2 separate years is high but not perfect.png](C:/Users/JJ/Pictures/correlation for performance in 2 separate years is high but not perfect.png)

![](C:/Users/JJ/Pictures/and this is our equation to predict 2014 from 2013.png)
...
![](C:/Users/JJ/Pictures/The other major application comes from measurement error models.png)

![](C:/Users/JJ/Pictures/falling_object dataset.png)

![](C:/Users/JJ/Pictures/a prabola.png)

![](C:/Users/JJ/Pictures/prabola relationship.png)

![measurement error](C:/Users/JJ/Pictures/we weite this model to include the variables and errors.png)

![we also assume there is no bias, which means the expected value of epsilion is 0.png](C:/Users/JJ/Pictures/we also assume there is no bias, which means the expected value of epsilion is 0.png)

[][*the LSE seems like a reasonal approach, NOTE the LSE calculation does not require the error to be approximately normal*]
![the LSE seems like a reasonal approach, NOTE the LSE calculation does not require the error to be approximately normal](C:/Users/JJ/Pictures/the lease square estimates, do you remember them.png)

[][*the lm function will find the betas that minimize the residual sum of squares.png*]
![](C:/Users/JJ/Pictures/the lm function will find the betas that minimize the residual sum of squares.png)

![](C:/Users/JJ/Pictures/broom function augment helps us check if our estimated parabola fit the data.png)

![](C:/Users/JJ/Pictures/high school physical knowledge gives us this equation.png)
...
![](C:/Users/JJ/Pictures/correlation is not causation.png)

![](C:/Users/JJ/Pictures/spurious correlations.png)

![](C:/Users/JJ/Pictures/a very strong correlation between divorce rate and margarine consumption1.png)

![](C:/Users/JJ/Pictures/a very strong correlation between divorce rate and margarine consumption2.png)

![now do you remember how we use "lm" to specify this line in ggplot ???](C:/Users/JJ/Pictures/correlation between divorce rate and margarine consumption.png)

![](C:/Users/JJ/Pictures/you can see many observed examples in this website completely dedicated to spurious correlations.png)

![](C:/Users/JJ/Pictures/data dredging.png)

![](C:/Users/JJ/Pictures/data fishing.png)

![](C:/Users/JJ/Pictures/data snooping.png)

![](C:/Users/JJ/Pictures/in united states its called cherry picking.png)

![these are just random, independent normally distributed data](C:/Users/JJ/Pictures/we create 1 million groups of data with monte carlo simulation.png)

![](C:/Users/JJ/Pictures/we simulated 1 million groups.png)

![](C:/Users/JJ/Pictures/1 million groups each with 25 observations.png)

![](C:/Users/JJ/Pictures/what we just constructured dataset are obvious not correlated.png)

![](C:/Users/JJ/Pictures/then we compute the correlation between a and y for each group.png)

![](C:/Users/JJ/Pictures/if we plot this specific group, it shows a convincing plot thta x and y are correlated.png)

![look how small the p value is here, though only one is small](C:/Users/JJ/Pictures/this particular form of data dredging is referred to as p-hacking .png)

![](C:/Users/JJ/Pictures/the multiple comparison problem.png)
